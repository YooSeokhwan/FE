...
.clearD {
  background: url('@/assets/image/clearD.png') no-repeat center center;
  background-size: cover;
}
.clearN {
  background: url('@/assets/image/clearN.png') no-repeat center center;
  background-size: cover;
}
.cloudsD {
  background: url('@/assets/image/cloudsD.png') no-repeat center center;
  background-size: cover;
}
.cloudsN {
  background: url('@/assets/image/cloudsN.png') no-repeat center center;
  background-size: cover;
}
.brokenCloudsD {
  background: url('@/assets/image/cloudsD.png') no-repeat center center;
...
.rainD {
  background: url('@/assets/image/rainD.png') no-repeat center center;
  background-size: cover;
}
.rainN {
  background: url('@/assets/image/rainN.png') no-repeat center center;
  background-size: cover;
}
.snowD {
  background: url('@/assets/image/snowD.png') no-repeat center center;
  background-size: cover;
}
.snowN {
  background: url('@/assets/image/snowN.png') no-repeat center center;
  background-size: cover;
}
.mistD {
  background: url('@/assets/image/cloudsD.png') no-repeat center center;
